...
public class GroupableTableHeaderUI extends BasicTableHeaderUI 
{
    public void paint(Graphics g, JComponent c) 
    {
        ...
        int columnMargin = header.getColumnModel().getColumnMargin() - 1; // SOLUCION: restar 1 al ancho de cada col. Las columnas se desfasan por el ancho extra de las H(...)
    ...
    private int getHeaderHeight() {
        ...
        for(int column = 0; column < columnModel.getColumnCount(); column++) 
        {
            ...
            if(renderer == null){
                renderer = header.getDefaultRenderer();
                return 50;   // ANEXO SOLUCION: Modifica la altura de los H(...)
            }
