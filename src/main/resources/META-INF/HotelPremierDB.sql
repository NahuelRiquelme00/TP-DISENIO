...
VALUES  (DEFAULT,'DNI',12345678,'BECKER','ALISSON','02-10-1992','ALIBECKER@GMAIL.COM','INGENIERO','BRASILERO','3429466178',1,1),
		...
		(DEFAULT,'DNI',20587514,'SIMPSON','HOMERO','09-12-2000', null,'SEGURIDAD','ARGENTINA','3445684598',1,1),
		(DEFAULT,'DNI',20597514,'SIMPSON','MARGE','09-11-2000',null,'AMA DE CASA','ARGENTINA','3325684598',1,1),
		(DEFAULT,'DNI',40487514,'SIMPSON','BART','09-12-2010',null,'ESTUDIANTE','ARGENTINA','3422684598',1,1),
		(DEFAULT,'DNI',40387514,'SIMPSON','LISA','09-12-2010',null,'ESTUDIANTE','ARGENTINA','3421684598',1,1),
		(DEFAULT,'DNI',40987514,'TORRES','DIEGO','09-05-1988',null,'ESTUDIANTE','ARGENTINA','3425687598',1,1),
		(DEFAULT,'DNI',40887514,'MORELO','RAFAEL','09-03-1988',null,'INGENIERO','ARGENTINA','3425684698',1,1),
		(DEFAULT,'DNI',40787514,'PEDROSA','CORAL','09-04-1988',null,'PROGRAMADOR','ARGENTINA','3425694598',1,1),
		(DEFAULT,'DNI',40687514,'PÉREZ','GUILLERMO','09-09-1988',null,'COCINERO','ARGENTINA','3425684518',1,1),
		(DEFAULT,'DNI',40587514,'JIMENEZ','GAEL','09-10-1988',null,'MAESTRO','ARGENTINA','3425684528',1,1),
		(DEFAULT,'DNI',40387514,'MENDEZ','EMÍLIO','09-11-1982',null,'ESTUDIANTE','ARGENTINA','3425664598',1,1),
		(DEFAULT,'DNI',40287514,'LOZANO','GIOVANNI','09-11-1982',null,'PORTERO','ARGENTINA','3425684598',1,1),
		(DEFAULT,'DNI',40187514,'JESUS','RAUL','09-12-1987',null,'REMISERO','ARGENTINA','3425684698',1,1),
		(DEFAULT,'DNI',30487514,'MACIA','MARIA','09-12-1988',null,'POLICIA','ARGENTINA','3425684518',1,1),
		(DEFAULT,'DNI',20487514,'LEIVA','IVANA','09-12-1986',null,'BOMBERO','ARGENTINA','3425684528',1,1);
...
INSERT INTO estadia VALUES (DEFAULT,'2021-12-12','2021-12-18', 4200.00 ,null,null,1,1,null),
						   (DEFAULT,'2021-12-13','2021-12-19', 6240.00,null,null,2,13,null),
						   (DEFAULT,'2021-12-14','2021-12-18', 6240.00,null,null,3,11,null),
						   (DEFAULT,'2021-12-13','2021-12-20', 4200.00,null,null,4,12,null);
...
INSERT INTO reserva VALUES 
	...
	(5,'JESUS','LEIVA',4561351);

--periodo_reserva(id_periodo_reserva, fecha_inicio, fecha_fin, numero_habitacion, id_reserva)
INSERT INTO periodo_reserva VALUES 
	(1,'2021-12-22','2021-12-25',4,1),
	(2,'2021-12-23','2021-12-25',5,2),
	(3,'2021-12-20','2021-12-25',6,3),
	(4,'2021-12-22','2021-12-25',7,4),
	(5,'2021-12-18','2021-12-22',12,5),
	(6,'2021-12-18','2021-12-22',20,5);
